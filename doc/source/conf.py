# -*- coding: utf-8 -*-
#
# EnhAtts documentation build configuration file, created by
# sphinx-quickstart on Fri Oct 18 16:51:26 2013.
#
...
latex_documents = [
  ('index', 'EnhAtts.tex', u'EnhAtts Documentation',
...
man_pages = [
    ('index', 'enhatts', u'EnhAtts Documentation',
     [u'Michael Pohl'], 1)
]
...
texinfo_documents = [
  ('index', 'EnhAtts', u'EnhAtts Documentation',
   u'Michael Pohl', 'EnhAtts', 'One line description of project.',
   'Miscellaneous'),
]
